<template>
  <section>
    <div class="container main_container">
        ...
        <div class="columns is-variable is-8">
          ...
          <div class="column">
            ...
            <p>
              ...
              <br />より効率良い、コストパフォーマンスに優れたウェブサイト制作をご提案致します。
              <br />
              <br />費用負担の大きい大規模なウェブサイト・サービス制作をしたのに効果がみられない・・・
              <br />ウェブでの集客を考えているが、何からはじめて良いかわからない。
              <br />お客様に寄り添ったウェブサイト・サービス制作で戦略的にお客様を応援します。
            </p>
        ...
        <div class="columns">
          <div class="column">
            <p>
              ...
              <br />新しい商材を販売したい……
              <br />自社ショッピングサイトを作りたい……
              <br />実際の広告・販売の戦略により、作るべきウェブサイトの規模は異なってくるはずです。
            </p>
            <p>私たちはお客様の意見を十分にヒアリングした上で、持てる経験と知識を遺憾なく発揮し、無駄なコストをかけず、着実に・最大限に効果がのぞめる方法をご提案させていただきます。</p>
            <p>
              また、当然ウェブサイトは作って終わりではありません。
              <br />ウェブサイトの運用から広告戦略などのアドバイスも含め、最後までご満足いただける結果が出せるようフォローします。
            </p>
          </div>
          <div class="column">
      ...
      <section>
        ...
        <div class="columns">
          ...
          <div class="column">
            ...
            <p>また、ブログ機能（CMS対応）の追加、ファイルダウンロード機能、独自ドメインの取得代行・設定などにも対応しています。</p>
      ...
      <section>
        <h2 class="title">幅広いウェブ戦略に対応しています</h2>
        <div class="columns is-variable is-8 is-multiline">
          ...
          <div class="column is-4">
            <div class="service_card">
              ...
              <h3 class="title is-small">ランディングページ作成</h3>
            </div>
          </div>
          <div class="column is-4">
            <div class="service_card">
              <img src="~assets/images/web_production/strategy.svg" />
              <h3 class="title is-small">分析・解析</h3>
            </div>
          </div>
          <div class="column is-4">
            <div class="service_card">
          ...
          <div class="column is-4">
            <div class="service_card">
              ...
              <h3 class="title is-small">SNS・オウンドメディア制作</h3>
            </div>
          </div>
          <div class="column is-4">
            <div class="service_card">
