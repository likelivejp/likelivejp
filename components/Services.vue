  ...
  <div>
    <div class="columns">
      <div class="column">
        ...
        <h3>IT顧問サービス</h3>
        <p>
          生産性の向上や、業務効率化にITを活用しましょう<br>
          <br>
          人材不足で適切なソフトウェア導入検討が出来ていない場合や、更なるサービス提供・顧客満足度を高めるたいといったお客様に。<br>
          新規サービスの製作はもちろん、既存ソフトウェアの導入検討などもお手伝いします。
        </p>
      ...
      <div class="column">
        ...
        <h3>Webサイト製作</h3>
        <p>
          コーポレートサイトから、開発スピードの必要なランディングページまで<br>
